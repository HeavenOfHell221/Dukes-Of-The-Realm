...
public enum CharacterCastleEnum implements Serializable
{
	 ...
	 * @param character Le caractère du Duke à qui appartient le château qui aura le caractère retourné.
	 * @return Un caractère.
	 */
	public static CharacterCastleEnum getRandomType(CharacterDukeEnum character)
	{
